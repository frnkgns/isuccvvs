...
<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        if(!empty($studentid) && !empty($position) && !empty($name) && !empty($college) && !empty($course) && !empty($quotes) && !empty($img)){
            ...
            if(mysqli_num_rows($result1) > 0){
                ...
                $query2 = "insert into candidates values ('$studentid','$position', '$name', '$college', '$course', '$quotes', '$img')";
